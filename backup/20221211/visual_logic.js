...
registerOnHover('Object_6.003', false, function() {
  assignMat('Object_6.003', 'selection_highlight_6.001');
  setMaterialValue('selection_highlight_6.001', '値', 0.5);
}, function() {
  assignMat('Object_6.003', 'teeth');
});

registerOnHover('Object_6.020', false, function() {
  assignMat('Object_6.020', 'selection_highlight_6.001');
  setMaterialValue('selection_highlight_6.001', '値', 0.5);
}, function() {
  assignMat('Object_6.020', 'teeth');
});

registerOnHover('Object_6.031', false, function() {
  assignMat('Object_6.031', 'selection_highlight_6.001');
  setMaterialValue('selection_highlight_6.001', '値', 0.5);
}, function() {
  assignMat('Object_6.031', 'teeth');
});

registerOnHover('Object_6.048', false, function() {
  assignMat('Object_6.048', 'selection_highlight_6.001');
  setMaterialValue('selection_highlight_6.001', '値', 0.5);
}, function() {
  assignMat('Object_6.048', 'teeth');
});

registerOnHover('Object_6.061', false, function() {
  assignMat('Object_6.061', 'selection_highlight_6.001');
  setMaterialValue('selection_highlight_6.001', '値', 0.5);
}, function() {
  assignMat('Object_6.061', 'teeth');
});

registerOnHover('Object_6.071', false, function() {
  assignMat('Object_6.071', 'selection_highlight_6.001');
  setMaterialValue('selection_highlight_6.001', '値', 0.5);
}, function() {
  assignMat('Object_6.071', 'teeth');
});

registerSetTimer('autorotate', 15, function() {
...
registerOnHover(['ALL_OBJECTS'], false, function() {
  handleAnnot(true, '?', 'Object_6.069.emp1.001', '', 'an1', undefined);
  eventHTMLElem('click', 'an1', false, function(event) {
    loadFile('popup/popup-an1.html', function() {
      handleAnnot(true, '説明を見る', 'Object_6.069.emp1.001', _pGlob.loadedFile, 'an1', undefined);
      setCSSRuleStyle('background', 'none', '.v3d-annotation-dialog', false, '');
    }, true);
  });
  handleAnnot(true, '?', 'Object_6.069.emp1.004', '', 'an2', undefined);
  eventHTMLElem('click', 'an2', false, function(event) {
    loadFile('popup/popup-an2.html', function() {
      handleAnnot(true, '説明を見る', 'Object_6.069.emp1.004', _pGlob.loadedFile, 'an2', undefined);
      setCSSRuleStyle('background', 'none', '.v3d-annotation-dialog', false, '');
    }, true);
  });
  handleAnnot(true, '?', 'Object_6.069.emp1', '', 'an3', undefined);
  eventHTMLElem('click', 'an3', false, function(event) {
    loadFile('popup/popup-an3.html', function() {
      handleAnnot(true, '説明を見る', 'Object_6.069.emp1', _pGlob.loadedFile, 'an3', undefined);
      setCSSRuleStyle('background', 'none', '.v3d-annotation-dialog', false, '');
    }, true);
  });
  handleAnnot(true, '?', 'Object_6.069.emp1.002', '', 'an4', undefined);
  eventHTMLElem('click', 'an4', false, function(event) {
    loadFile('popup/popup-an4.html', function() {
      handleAnnot(true, '説明を見る', 'Object_6.069.emp1.002', _pGlob.loadedFile, 'an4', undefined);
      setCSSRuleStyle('background', 'none', '.v3d-annotation-dialog', false, '');
    }, true);
  });
  handleAnnot(true, '?', 'Object_6.069.emp1.005', '', 'an5', undefined);
  eventHTMLElem('click', 'an5', false, function(event) {
    loadFile('popup/popup-an5.html', function() {
      handleAnnot(true, '説明を見る', 'Object_6.069.emp1.005', _pGlob.loadedFile, 'an5', undefined);
      setCSSRuleStyle('background', 'none', '.v3d-annotation-dialog', false, '');
    }, true);
  });
  handleAnnot(true, '?', 'Object_6.069.emp1.003', '', 'an6', undefined);
  eventHTMLElem('click', 'an6', false, function(event) {
    loadFile('popup/popup-an6.html', function() {
      handleAnnot(true, '説明を見る', 'Object_6.069.emp1.003', _pGlob.loadedFile, 'an6', undefined);
      setCSSRuleStyle('background', 'none', '.v3d-annotation-dialog', false, '');
    }, true);
  });
}, function() {
  setHTMLElemStyle('display', 'none', ['an1', 'an2', 'an3', 'an4', 'an5', 'an6'], false);
});
